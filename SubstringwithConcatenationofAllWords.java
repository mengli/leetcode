 ...
 *
 * <p>For example, given: S: "barfoothefoobarman" L: ["foo", "bar"]
 *
...
public class SubstringwithConcatenationofAllWords {
  ...
  private int check(
      String s, int start, int end, int m, int n, String[] L, HashMap<String, Integer> smap) {
