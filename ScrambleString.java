 ...
 *
 * <p>great / \ gr eat / \ / \ g r e at / \ a t To scramble the string, we may choose any non-leaf
 * node and swap its two children.
 *
 * <p>For example, if we choose the node "gr" and swap its two children, it produces a scrambled
 * string "rgeat".
 *
 * <p>rgeat / \ rg eat / \ / \ r g e at / \ a t We say that "rgeat" is a scrambled string of
 * "great".
 *
 * <p>Similarly, if we continue to swap the children of nodes "eat" and "at", it produces a
 * scrambled string "rgtae".
 *
 * <p>rgtae / \ rg tae / \ / \ r g ta e / \ t a We say that "rgtae" is a scrambled string of
 * "great".
 *
