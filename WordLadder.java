 ...
 *
 * <p>As one shortest transformation is "hit" -> "hot" -> "dot" -> "dog" -> "cog", return its length
 * 5.
 *
 * <p>Note:
 *
 * <p>Return 0 if there is no such transformation sequence. All words have the same length. All
