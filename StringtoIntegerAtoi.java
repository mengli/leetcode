 ...
 * <p>Hint:
 *
 * <p>Carefully consider all possible input cases. If you want a challenge, please do not see below
 * and ask yourself what are the possible input cases.
 *
 * <p>Notes:
 *
 * <p>It is intended for this problem to be specified vaguely (ie, no given input specs). You are
 * responsible to gather all the input requirements up front.
 *
 * <p>Requirements for atoi: The function first discards as many whitespace characters as necessary
 ...
 *
 * <p>If no valid conversion could be performed, a zero value is returned. If the correct value is
